...
#ifndef QFGUI_ELLIPSESELECTION_H
#define QFGUI_ELLIPSESELECTION_H
...
class EllipseSelection: public RectangularTool
{
    Q_OBJECT
public:
    EllipseSelection(ToolSettings *settings = NULL):
...
#endif // QFGUI_ELLIPSESELECTION_H
